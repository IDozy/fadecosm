...
import sencico4 from "../../images/Proyectos/SENCICO/SENCICO4.jpg";
const proyectos = [
    {
      id:"0",
      ...
      producto: "Rejillas pluviales para drenaje",
    ...
    },
    {
      ...
      imagenes: [tecnof1, tecnof2,tecnof3,tecnof4],
    },
    {
      id:"2",
      titulo: "FABRICACIÓN DE BLOQUES DE CONCRETO ARMADO",
      imagen: equans,
      empresa: "EQUANS - CAM SERVICIOS DEL PERÚ",
    ...
    },
    {
      ...
      lugar: "Santa Apolonia Cajamarca - 2023",
      ...
      imagenes: [ mpc2,mpc1, mpc3, mpc4,mpc5],
    },
    {
      id:"5",
     ...
     
    {
      ...
      lugar: "Qhapaq Ñan - Cajamarca 2023",
      proyecto: "''MEJORAMIENTO Y AMPLIACIÓN DEL SERVICIO DE CAPACITACIÓN EN LA INDUSTRIA DE LA CONSTRUCCIÓN DE LA UNIDAD OPERATIVA SENCICO CAJAMARCA''",
